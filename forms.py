...
class ContactForm(Form):
    ...
    ref1phone = TextField("Personal Reference Phone",  [validators.Required("Please complete personal reference information.")])
    ...
    ref2phone = TextField("Personal Reference Phone",  [validators.Required("Please complete personal reference information.")])
